cd $LFS/sources
bash -ex /scripts/chapter-06/m4.sh
bash -ex /scripts/chapter-06/ncurses.sh
bash -ex /scripts/chapter-06/bash.sh
bash -ex /scripts/chapter-06/coreutils.sh
bash -ex /scripts/chapter-06/diffutils.sh
bash -ex /scripts/chapter-06/file.sh
